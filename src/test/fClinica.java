...
public class fClinica extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 60, 320, 70));
        ...
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 390, -1, -1));
...
//        
//        
//        JOptionPane.showMessageDialog(null, this.us.getUsuario() +" "+ this.us.getClave());
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
       CrearCuenta cnt = new CrearCuenta();
       cnt.setVisible(true);
